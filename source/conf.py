# -*- coding: utf-8 -*-
#
# Plone Deployment documentation build configuration file, created by
...
htmlhelp_basename = 'PloneDeploymentdoc'
...
intersphinx_mapping = {'http://docs.python.org/': None, 'http://www.buildout.org/index.html': None}
